    ...
    class WRCPT_Admin_Sidebar
    {
        ...
        protected function render_pro_features_box()
        {
            ...
            <div id="wrcptusage-features" class="wrcptusage-sidebar">
                ...
                <div class="wrcptusage-feature-body">
                    ...
                    <a href="<?php echo esc_url('https://sandbox.realwebcare.com/sandbox-demo-creator-wrc-pricing-tables/'); ?>" class="wrcpt-sanbox-button" target="_blank" rel="noopener">
                    ...
                    <a href="<?php echo esc_url('https://www.realwebcare.com/demo/?product_id=wrc-pricing-tables-ultimate'); ?>" target="_blank" rel="noopener">
        ...
        protected function render_plugin_info_box()
        {
            ...
            <div id="wrcptusage-info" class="wrcptusage-sidebar">
                ...
                <ul class="wrcptusage-list">
                    <li>
                        <a href="https://www.realwebcare.com/item/wordpress-responsive-pricing-table-plugin/" target="_blank" rel="noopener">
                            <?php esc_html_e('WRC Pricing Tables - Ultimate', 'wrc-pricing-tables'); ?>
                        </a>
                    </li>
                    <li>
                        <a href="https://wordpress.org/plugins/t4b-news-ticker/" target="_blank" rel="noopener">
                            <?php esc_html_e('T4B News Ticker', 'wrc-pricing-tables'); ?>
                        </a>
                    </li>
                    <li>
                        <a href="https://wordpress.org/plugins/rwc-team-members/" target="_blank" rel="noopener">
                ...
                <ul class="wrcptusage-list">
                    <li>
                        ...
                        <a href="https://wordpress.org/plugins/wrc-pricing-tables/changelog/" target="_blank" rel="noopener">
                            <?php echo esc_html(WRCPT_PLUGIN_VERSION); ?>
                        </a>
                    </li>
                    ...
                    <li><?php esc_html_e('Last Update: ' . WRCPT_LAST_UPDATED, 'wrc-pricing-tables'); ?></li>
                    <li>
